...
import { LogOut, LogIn, User, BookOpen, GraduationCap } from "lucide-react";
        ...
        <header className="w-full bg-white/70 dark:bg-zinc-950/70 backdrop-blur-md border-b border-zinc-200/50 dark:border-zinc-800/50 sticky top-0 z-50 transition-colors duration-300">
            <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                ...
                <Link href="/" className="flex items-center gap-3 group transition-transform active:scale-98">
                    ...
                    <div className="w-10 h-10 rounded-xl bg-zinc-950 dark:bg-white text-white dark:text-zinc-950 flex items-center justify-center font-bold text-xl shadow-md transition-all duration-200 group-hover:shadow-lg group-hover:rotate-3">
                        A
                    </div>
                    <span className="font-semibold text-lg text-zinc-900 dark:text-zinc-50 tracking-tight group-hover:text-zinc-600 dark:group-hover:text-zinc-300 transition-colors">
                        AuthForge
                    </span>
                </Link>
                ...
                <nav className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-4 pl-4 border-l border-zinc-200 dark:border-zinc-800">
                        {isLoggedIn ? (
                            ...
                            <Link 
                                href="/login" 
                                className="h-10 px-5 rounded-xl bg-zinc-950 hover:bg-zinc-800 dark:bg-white dark:hover:bg-zinc-100 text-white dark:text-zinc-950 font-semibold text-xs transition-all duration-200 flex items-center gap-2 shadow-md hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 active:scale-98"
                            >
